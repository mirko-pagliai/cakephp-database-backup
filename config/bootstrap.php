...
$defaults = [
    ...
    'DatabaseBackup.Mysql.new.export' => '"${:BINARY}" --defaults-file="${:AUTH_FILE}" "${:DB_NAME}"',
    'DatabaseBackup.Mysql.new.import' => '"${:BINARY}" --defaults-extra-file="${:AUTH_FILE}" "${:DB_NAME}"',
    'DatabaseBackup.Postgres.new.export' => '"${:BINARY}" --format=c -b --dbname=\'postgresql://"${:DB_USER}""${:DB_PASSWORD}"@"${:DB_HOST}"/"${:DB_NAME}"\'',
    'DatabaseBackup.Postgres.new.import' => '"${:BINARY}" --format=c -c -e --dbname=\'postgresql://"${:DB_USER}""${:DB_PASSWORD}"@"${:DB_HOST}"/"${:DB_NAME}"\'',
    'DatabaseBackup.Sqlite.new.export' => '"${:BINARY}" "${:DB_NAME}" .dump',
    'DatabaseBackup.Sqlite.new.import' => '"${:BINARY}" "${:DB_NAME}"',
];
